...
path = "Dataset_Train"  # folder with all the class folders
...
model = myModel()
print(model.summary())
history = model.fit_generator(dataGen.flow(X_train, y_train),epochs=epochs_val,validation_data=(X_validation, y_validation),shuffle=1)
